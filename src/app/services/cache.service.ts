...
import {CachableRoutePatterns,LocalStorageTypes} from '../common/shared/constants'
...
export class HttpCacheService implements HttpCache {
	...
	constructor() {
		console.log(`HttpCacheService constructed for ${Object.keys(this.cachableRoutes).join(',\n')}`);
	}
